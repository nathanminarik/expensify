...
test('should call onSubmit prop for valid form submission', () => {
  ...
  // This requires the function to have been called
  // expect(onSubmitSpy.toHaveBeenCalled());

  // To check for arguments you need to call the function with them.
  // onSubmitSpy('Nathan', 'DC');
  // expect(onSubmitSpy).toHaveBeenCalledWith('Nathan', 'DC');
